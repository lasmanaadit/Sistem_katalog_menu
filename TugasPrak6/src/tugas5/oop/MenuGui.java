...
public class MenuGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmb_pilih.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Soto Ayam", "Mie Ayam", "Soto Ayam Teh manis", "Mie ayam teh manis" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
       memo.setText("");
       String namaInput = txt_nama.getText();
       int pilihan = cmb_pilih.getSelectedIndex();

       MenuPelanggan menuPelanggan = new MenuPelanggan();
       Menuitem menu = menuPelanggan.buatMenu(namaInput, pilihan);
       memo.append(menu.getDeskripsi());
