...
private int getHargaMenu(String menu) {
 ...
 private void hitungTotalHarga() {
    ...
    int hargaMenu = getHargaMenu(menuPelanggan);
    String kategoriMenu = cmb_kategori.getSelectedItem().toString();

    if (namaPelanggan.isEmpty() || menuPelanggan.isEmpty() || jumlahText.isEmpty()) {
    ...
    int totalHarga = hargaMenu * jumlah;

    // ✅ Gunakan interface DeskripsiMenu (POLIMORFISME)
    DeskripsiMenu item = new Menuitem(namaPelanggan, menuPelanggan, totalHarga, kategoriMenu);
    System.out.println(item.getDeskripsi()); // ← ini log di console, bisa dihilangkan kalau tidak perlu
