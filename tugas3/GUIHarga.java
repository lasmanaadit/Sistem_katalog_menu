 ...
 * @author lasmanaadit
 */
public class GUIHarga extends javax.swing.JFrame {

    /**
     * Creates new form GUIHarga
     */
    public GUIHarga() {
        initComponents();
    }
    ...
    private void smpnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_smpnActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) tblMenu2.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIHarga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
